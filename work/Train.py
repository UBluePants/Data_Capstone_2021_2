import time
from data.YJ_dataloader import YJ_Dataloader
...
class Train:
    def __init__(self, trainset, testset):
        ...
        self._dataset_train = trainset
        
        self._dataset_test = testset
    ...
    def _train_epoch(self, i_epoch):
        ...
        for i_train_batch, train_batch in enumerate(self._dataset_train):
            ...
            if (i_train_batch + 1) % self._opt.fake_real_rate == 0:
                train_batch_split['none_occ_img'] = train_batch['natural_img']
                train_batch_split['none_occ_attr'] = None
                train_batch_split['occ_img'] = train_batch['occ_img']
                train_batch_split['occ_attr'] = None
                has_GT_flag = False
                has_attr_flag = False        

            else:
                train_batch_split['none_occ_img'] = train_batch['GT_img']
                train_batch_split['none_occ_attr'] = train_batch['GT_attr']

                train_batch_split['occ_img'] = train_batch['synth_img']
                train_batch_split['occ_attr'] = train_batch['synth_attr']
    ...
    def _display_visualizer_train(self, i_epoch, total_steps, has_GT, has_attr):
        ...
        if has_GT == True and has_attr == True:
            flag = '_w_GT_w_attr'
        if has_GT == False and has_attr == False:
            flag = '_wo_GT_wo_attr'
    ...
    def _display_visualizer_val(self, i_epoch, total_steps, has_GT, has_attr):
        ...
        for i_val_batch, val_batch in enumerate(self._dataset_test):
            ...
            val_batch_split['none_occ_img'] = val_batch['natural_img']
            val_batch_split['none_occ_attr'] = None

            val_batch_split['occ_img'] = val_batch['occ_img']
            val_batch_split['occ_attr'] = None
